...
class _TicketScreenState extends State<TicketScreen> {
  ...
  Future<void> fetchEvents() async {
    try {
      final eventsResponse = await http.get(Uri.parse('http://127.0.0.1:3001/events'));
      final participantsResponse = await http.get(Uri.parse('http://127.0.0.1:3001/participants/user/${widget.loggedInUser}'));
