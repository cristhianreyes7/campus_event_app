...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Future<void> fetchHostEvents() async {
    try {
      final response = await http.get(Uri.parse('http://127.0.0.1:3001/events'));
  ...
  Future<void> _createEvent() async {
    ...
    final response = await http.post(
      Uri.parse('http://127.0.0.1:3001/events'),
  ...
  Future<void> _deleteEvent(int eventId) async {
    final response = await http.delete(Uri.parse('http://127.0.0.1:3001/events/$eventId'));
    if (response.statusCode == 200) {
      fetchHostEvents();
      ScaffoldMessenger.of(context).showSnackBar(
  ...
  Future<void> _editEvent(int eventId, Map<String, dynamic> updatedEvent) async {
    final response = await http.put(
      Uri.parse('http://127.0.0.1:3001/events/$eventId'),
      headers: {"Content-Type": "application/json"},
